...
If your **Group Workspace** integrates with QuickBooks Online, you can export billable expenses for invoicing. Configure this under the **Coding** tab in the connection settings.
