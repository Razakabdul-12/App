...
const translations = {
    common: {
        ...
        previous: 'Poprzedni',
        goBack: 'Wróć',
        switchToExpensifyClassic: 'Przełącz na Expensify Classic',
        create: 'Utwórz',
        add: 'Dodaj',
    ...
    workspace: {
        common: {
            ...
            perDiem: 'Per diem',
            members: 'Członkowie',
            accounting: 'Księgowość',            rules: 'Zasady',
        ...
        accounting: {
            ...
            syncError: () => 'Nie można połączyć się z integracją',
            accounts: 'Plan kont',
            taxes: 'Podatki',
            ...
            enableContinuousReconciliation: ({connectionName}: EnableContinuousReconciliationParams) =>
                `<muted-text-label>Aby włączyć funkcję ciągłego uzgadniania, włącz automatyczną synchronizację dla ${connectionName}.</muted-text-label>`,
        ...
        rules: {
            individualExpenseRules: {
                ...
                subtitle: ({categoriesPageLink}: IndividualExpenseRulesSubtitleParams) =>
                    `<muted-text>Ustaw limity wydatków i domyślne wartości dla poszczególnych wydatków. Możesz również tworzyć reguły dla <a href="${categoriesPageLink}">kategorii</a>.</muted-text>`,
                ...
                billableDefaultDescription:
                    '<muted-text>Wybierz, czy wydatki gotówkowe i kartą kredytową powinny być domyślnie rozliczane.</muted-text>',
                billable: 'Podlegające fakturowaniu',
