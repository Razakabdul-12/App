...
const translations = {
    common: {
        ...
        previous: 'Anterior',
        goBack: 'Voltar',
        switchToExpensifyClassic: 'Mudar para Expensify Classic',
        create: 'Criar',
        add: 'Adicionar',
        resend: 'Reenviar',
        save: 'Salvar',
    ...
    iou: {
        ...
        automaticallySubmitted: 'enviado automaticamente',
        ...
        changePolicyEducational: {
            ...
            workflows: 'Este relatório agora pode ser encaminhado para um <strong>aprovador diferente</strong>.',
        },
        ...
        changeApprover: {
            ...
            description: 'Você também pode alterar o aprovador de forma permanente nas configurações do seu workspace.',
    ...
    twoFactorAuth: {
        ...
        twoFactorAuthIsRequiredForAdminsDescription:
            'Sua conexão de contabilidade requer o uso de autenticação de dois fatores. Para continuar usando o Expensify, por favor, ative-a.',
        twoFactorAuthCannotDisable: 'Não é possível desativar a 2FA',
        twoFactorAuthRequired: 'A autenticação de dois fatores (2FA) é necessária e não pode ser desativada.',
    },
    recoveryCodeForm: {
        error: {
    ...
    workflowsPage: {
        ...
        emptyContent: {
            ...
            expensesFromSubtitle: 'Todos os membros do workspace já têm um aprovador atribuído.',
            approverSubtitle: 'Todos os aprovadores disponíveis já foram atribuídos.',
        },
    },
    ...
    travel: {
        ...
        termsAndConditions: {
            ...
            subtitle: 'Por favor, concorde com os termos e condições da Expensify Travel.',
    ...
    workspace: {
        common: {
            ...
            travel: 'Viagem',
            members: 'Membros',
            accounting: 'Contabilidade',            rules: 'Regras',
        ...
        accounting: {
            ...
            syncError: () => 'Não é possível conectar à integração',
            ...
            autoSync: 'Auto-sync',
            autoSyncDescription:
                'Sincronize sua integração contábil e o Expensify automaticamente todos os dias. Exporte relatórios finalizados em tempo real.',
            ...
            enableContinuousReconciliation: ({connectionName}: EnableContinuousReconciliationParams) =>
                `<muted-text-label>Para ativar a reconciliação contínua, habilite a sincronização automática para ${connectionName}.</muted-text-label>`,
        ...
        upgrade: {
            ...
            commonFeatures: {
                ...
                benefits: {
                    ...
                    benefit1: 'Conexões avançadas de contabilidade',
        ...
        rules: {
            individualExpenseRules: {
                ...
                subtitle: ({categoriesPageLink}: IndividualExpenseRulesSubtitleParams) =>
                    `<muted-text>Defina controles de gastos e padrões para despesas individuais. Você também pode criar regras para <a href="${categoriesPageLink}">categorias</a>.</muted-text>`,
                ...
                billableDefaultDescription:
                    '<muted-text>Escolha se as despesas em dinheiro e cartão de crédito devem ser faturáveis por padrão.</muted-text>',
                billable: 'Faturável',
    ...
    subscription: {
        ...
        yourPlan: {
            ...
            collect: {
                ...
                benefit6: 'Integrações QuickBooks',
            ...
            control: {
                ...
                benefit4: 'Integrações ERP (Oracle)',
