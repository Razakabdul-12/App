...
const translations = {
        ...
        tasks: {
            ...
            splitExpenseTask: {
                ...
                description:
                    ...
                    '1. Abre el chat con todas las personas con las que necesitas dividir.\n' +
                    `2. Haz clic en el botón verde ${CONST.CUSTOM_EMOJIS.GLOBAL_CREATE} en el campo de mensaje.\n` +
                    '3. Elige *Dividir gasto*.\n' +
                    '4. Crea el gasto seleccionando *Manual*, *Escanear* o *Distancia*.\n\n' +
    ...
    workspace: {
        ...
        accounting: {
            ...
            syncError: () => 'No se ha podido conectar a la integración',
            ...
            enableContinuousReconciliation: ({connectionName}: EnableContinuousReconciliationParams) =>
                `<muted-text-label>Para activar la Conciliación Continua, habilita la autosincronización para ${connectionName}.</muted-text-label>`,
