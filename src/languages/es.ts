...
const translations = {
    common: {
        ...
        previous: 'Anterior',
        goBack: 'Volver',
        switchToExpensifyClassic: 'Cambiar a Expensify Classic',
        add: 'Añadir',
        resend: 'Reenviar',
        save: 'Guardar',
    ...
    twoFactorAuth: {
        ...
        twoFactorAuthIsRequiredForAdminsDescription:
            'Tu conexión de contabilidad requiere el uso de autenticación de dos factores. Por favor, habilítala para seguir usando Expensify.',
        twoFactorAuthCannotDisable: 'No se puede desactivar la autenticación de dos factores (2FA)',
        twoFactorAuthRequired: 'La autenticación de dos factores (2FA) es obligatoria y no se puede desactivar.',
    },
    recoveryCodeForm: {
        error: {
    ...
    travel: {
        ...
        termsAndConditions: {
            ...
            subtitle: 'Por favor, acepta los términos y condiciones de Expensify Travel.',
    ...
    workspace: {
        ...
        accounting: {
            ...
            autoSyncDescription:
                'Sincroniza tu integración contable y Expensify automáticamente todos los días. Exporta los informes finalizados en tiempo real.',
        ...
        upgrade: {
            ...
            commonFeatures: {
                ...
                benefits: {
                    ...
                    benefit1: 'Conexiones avanzadas de contabilidad',
        ...
        downgrade: {
            commonFeatures: {
                ...
                benefits: {
                    ...
                    benefit1: 'Conexiones de contabilidad',
                    benefit2: 'Reglas inteligentes de gastos',
                    benefit3: 'Flujos de aprobación de varios niveles',
                    benefit4: 'Controles de seguridad mejorados',
                    headsUp: '¡Atención!',
        ...
        rules: {
            individualExpenseRules: {
                ...
                subtitle: ({categoriesPageLink}: IndividualExpenseRulesSubtitleParams) =>
                    `<muted-text>Establece controles y valores predeterminados para gastos individuales. También puedes crear reglas para <a href="${categoriesPageLink}">categorías</a>.</muted-text>`,
                ...
                billableDefaultDescription:
                    '<muted-text>Elige si los gastos en efectivo y con tarjeta de crédito deben ser facturables por defecto.</muted-text>',
                billable: 'Facturable',
    ...
    subscription: {
        ...
        yourPlan: {
            ...
            collect: {
                ...
                benefit6: 'Integraciones con QuickBooks',
            ...
            control: {
                ...
                benefit4: 'Integraciones con ERP (Oracle)',
