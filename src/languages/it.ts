...
const translations = {
    ...
    twoFactorAuth: {
        ...
        twoFactorAuthIsRequiredForAdminsDescription:
            "La tua connessione contabile richiede l'uso dell'autenticazione a due fattori. Per continuare a utilizzare Expensify, ti preghiamo di abilitarla.",
        twoFactorAuthCannotDisable: "Impossibile disabilitare l'autenticazione a due fattori (2FA)",
        twoFactorAuthRequired: "L'autenticazione a due fattori (2FA) è necessaria e non può essere disabilitata.",
    },
    recoveryCodeForm: {
        error: {
    ...
    travel: {
        ...
        termsAndConditions: {
            ...
            subtitle: 'Accettate i termini e le condizioni di Expensify Travel.',
    ...
    workspace: {
        common: {
            ...
            travel: 'Viaggio',
            members: 'Membri',
            accounting: 'Contabilità',            rules: 'Regole',
        ...
        accounting: {
            ...
            autoSyncDescription:
                'Sincronizza automaticamente la tua integrazione contabile ed Expensify ogni giorno. Esporta i report finalizzati in tempo reale.',
        ...
        upgrade: {
            ...
            commonFeatures: {
                ...
                benefits: {
                    ...
                    benefit1: 'Connessioni contabili avanzate',
        ...
        downgrade: {
            commonFeatures: {
                ...
                benefits: {
                    ...
                    benefit1: 'Connessioni contabili',
                    benefit2: 'Regole intelligenti per le spese',
                    benefit3: 'Flussi di lavoro di approvazione multilivello',
                    benefit4: 'Controlli di sicurezza avanzati',
                    headsUp: 'Attenzione!',
        ...
        rules: {
            individualExpenseRules: {
                ...
                subtitle: ({categoriesPageLink}: IndividualExpenseRulesSubtitleParams) =>
                    `<muted-text>Imposta controlli di spesa e valori predefiniti per le singole spese. Puoi anche creare regole per <a href="${categoriesPageLink}">categorie</a>.</muted-text>`,
                ...
                billableDefaultDescription:
                    '<muted-text>Scegli se le spese in contanti e con carta di credito devono essere fatturabili per impostazione predefinita.</muted-text>',
                billable: 'Fatturabile',
    ...
    subscription: {
        ...
        yourPlan: {
            ...
            collect: {
                ...
                benefit6: 'Integrazioni QuickBooks',
            ...
            control: {
                ...
                benefit4: 'Integrazioni ERP (Oracle)',
