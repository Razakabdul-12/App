...
const translations = {
    common: {
        ...
        previous: 'Previous',
        goBack: 'Go back',
        switchToExpensifyClassic: 'Switch to Expensify Classic',
        create: 'Create',
        add: 'Add',
        resend: 'Resend',
        save: 'Save',
    ...
    twoFactorAuth: {
        ...
        twoFactorAuthIsRequiredForAdminsDescription: 'Two-factor authentication is required to continue using Expensify. Please enable it.',
        twoFactorAuthCannotDisable: 'Cannot disable 2FA',
        twoFactorAuthRequired: 'Two-factor authentication (2FA) is required and cannot be disabled.',
    },
    recoveryCodeForm: {
        error: {
    ...
    travel: {
        ...
        termsAndConditions: {
            ...
            subtitle: 'Please agree to the Expensify Travel terms & conditions.',
        ...
        rules: {
            individualExpenseRules: {
                ...
                subtitle: ({categoriesPageLink}: IndividualExpenseRulesSubtitleParams) =>
                    `<muted-text>Set spend controls and defaults for individual expenses. You can also create rules for <a href="${categoriesPageLink}">categories</a>.</muted-text>`,
                ...
                billableDefaultDescription:
                    '<muted-text>Choose whether cash and credit card expenses should be billable by default.</muted-text>',
                billable: 'Billable',
