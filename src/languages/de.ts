...
const translations = {
    common: {
        ...
        previous: 'Vorherige',
        goBack: 'Zurückgehen',
        switchToExpensifyClassic: 'Zu Expensify Classic wechseln',
        create: 'Erstellen',
        add: 'Hinzufügen',
    ...
    twoFactorAuth: {
        ...
        twoFactorAuthIsRequiredForAdminsDescription:
            'Ihre Buchhaltungsverbindung erfordert die Verwendung der Zwei-Faktor-Authentifizierung. Um Expensify weiterhin zu nutzen, aktivieren Sie diese bitte.',
        twoFactorAuthCannotDisable: '2FA kann nicht deaktiviert werden.',
        twoFactorAuthRequired: 'Die Zwei-Faktor-Authentifizierung (2FA) ist erforderlich und kann nicht deaktiviert werden.',
    },
    recoveryCodeForm: {
        error: {
    ...
    travel: {
        ...
        termsAndConditions: {
            ...
            subtitle: 'Bitte stimmen Sie den Allgemeinen Geschäftsbedingungen von Expensify Travel zu.',
    ...
    workspace: {
        ...
        accounting: {
            ...
            syncError: () => 'Kann keine Verbindung zur Integration herstellen',
            accounts: 'Kontenplan',
            taxes: 'Steuern',
            imported: 'Importiert',
            ...
            autoSyncDescription:
                'Synchronisieren Sie Ihre Buchhaltungsintegration und Expensify automatisch jeden Tag. Exportieren Sie abgeschlossene Berichte in Echtzeit.',
            ...
            enableContinuousReconciliation: ({connectionName}: EnableContinuousReconciliationParams) =>
                `<muted-text-label>Um den kontinuierlichen Abgleich zu aktivieren, aktivieren Sie bitte die automatische Synchronisierung für ${connectionName}.</muted-text-label>`,
        ...
        upgrade: {
            ...
            commonFeatures: {
                ...
                benefits: {
                    ...
                    benefit1: 'Erweiterte Buchhaltungsverbindungen',
        ...
        downgrade: {
            commonFeatures: {
                ...
                benefits: {
                    ...
                    benefit1: 'Buchhaltungsverbindungen',
                    benefit2: 'Intelligente Ausgabenregeln',
                    benefit3: 'Genehmigungsabläufe mit mehreren Ebenen',
                    benefit4: 'Erweiterte Sicherheitskontrollen',
                    headsUp: 'Achtung!',
        ...
        rules: {
            individualExpenseRules: {
                ...
                subtitle: ({categoriesPageLink}: IndividualExpenseRulesSubtitleParams) =>
                    `<muted-text>Legen Sie Ausgabenkontrollen und Standardwerte für einzelne Ausgaben fest. Sie können auch Regeln für <a href="${categoriesPageLink}">Kategorien</a> erstellen.</muted-text>`,
                ...
                billableDefaultDescription:
                    '<muted-text>Wählen Sie aus, ob Bar- und Kreditkartenausgaben standardmäßig abrechnungsfähig sein sollen.</muted-text>',
                billable: 'Abrechenbar',
    ...
    subscription: {
        ...
        yourPlan: {
            ...
            collect: {
                ...
                benefit6: 'QuickBooks-Integrationen',
            ...
            control: {
                ...
                benefit4: 'ERP-Integrationen (Oracle)',
