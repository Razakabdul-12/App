...
const translations = {
    common: {
        ...
        previous: '上一个',
        goBack: '返回',
        switchToExpensifyClassic: '切换到 Expensify Classic',
        create: '创建',
        add: '添加',
        resend: '重新发送',
        save: '保存',
    ...
    travel: {
        ...
        termsAndConditions: {
            ...
            title: '条款和条件',
            label: '我同意条款和条件',
            subtitle: '请同意 Expensify Travel 条款和条件。',
        ...
        rules: {
            individualExpenseRules: {
                ...
                subtitle: ({categoriesPageLink}: IndividualExpenseRulesSubtitleParams) =>
                    `<muted-text>为单项支出设置支出控制和默认值。您还可以为<a href="${categoriesPageLink}">类别</a>创建规则。</muted-text>`,
                ...
                billableDefaultDescription:
                    '<muted-text>选择现金和信用卡支出是否默认可计费。</muted-text>',
                billable: '可计费的',
