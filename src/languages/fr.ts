...
const translations = {
    common: {
        ...
        previous: 'Précédent',
        goBack: 'Retourner',
        switchToExpensifyClassic: 'Passer à Expensify Classic',
        create: 'Créer',
        add: 'Ajouter',
        resend: 'Renvoyer',
        save: 'Enregistrer',
    ...
    iou: {
        ...
        automaticallySubmitted: 'soumis automatiquement',
        ...
        changePolicyEducational: {
            ...
            workflows: 'Ce rapport peut désormais être envoyé à un <strong>approbateur différent</strong>.',
        },
        ...
        changeApprover: {
            ...
            description: "Vous pouvez également modifier l'approbateur de façon permanente dans les paramètres de votre espace de travail.",
    ...
    twoFactorAuth: {
        ...
        twoFactorAuthIsRequiredForAdminsDescription:
            "Votre connexion comptable nécessite l'utilisation de l'authentification à deux facteurs. Pour continuer à utiliser Expensify, veuillez l'activer.",
        twoFactorAuthCannotDisable: 'Impossible de désactiver la 2FA',
        twoFactorAuthRequired: "L'authentification à deux facteurs (2FA) est requise et ne peut pas être désactivée.",
    },
    recoveryCodeForm: {
        error: {
    ...
    workflowsPage: {
        ...
        emptyContent: {
            ...
            expensesFromSubtitle: "Tous les membres de l'espace de travail ont déjà un approbateur assigné.",
            approverSubtitle: 'Tous les approbateurs disponibles sont déjà assignés.',
        },
    },
    ...
    workspace: {
        common: {
            ...
            travel: 'Voyage',
            members: 'Membres',
            accounting: 'Comptabilité',            rules: 'Règles',
        ...
        accounting: {
            ...
            syncError: () => "Impossible de se connecter à l'intégration",
            ...
            autoSyncDescription:
                'Synchronisez automatiquement votre intégration comptable et Expensify chaque jour. Exportez les rapports finalisés en temps réel.',
            ...
            enableContinuousReconciliation: ({connectionName}: EnableContinuousReconciliationParams) =>
                `<muted-text-label>Pour activer la réconciliation continue, veuillez activer la synchronisation automatique pour ${connectionName}.</muted-text-label>`,
        ...
        upgrade: {
            ...
            commonFeatures: {
                ...
                benefits: {
                    ...
                    benefit1: 'Connexions comptables avancées',
        ...
        downgrade: {
            commonFeatures: {
                ...
                benefits: {
                    ...
                    benefit1: 'Connexions comptables',
                    benefit2: 'Règles de dépenses intelligentes',
                    benefit3: "Flux de travail d'approbation à plusieurs niveaux",
                    benefit4: 'Contrôles de sécurité renforcés',
                    headsUp: 'Attention !',
        ...
        rules: {
            individualExpenseRules: {
                title: 'Dépenses',
                subtitle: ({categoriesPageLink}: IndividualExpenseRulesSubtitleParams) =>
                    `<muted-text>Définissez des contrôles de dépenses et des valeurs par défaut pour chaque dépense. Vous pouvez également créer des règles pour les <a href="${categoriesPageLink}">catégories</a>.</muted-text>`,
                ...
                billableDefaultDescription:
                    '<muted-text>Choisissez si les dépenses en espèces et par carte de crédit doivent être facturables par défaut.</muted-text>',
                billable: 'Facturable',
    ...
    subscription: {
        ...
        yourPlan: {
            ...
            collect: {
                ...
                benefit6: 'Intégrations QuickBooks',
            ...
            control: {
                ...
                benefit4: 'Intégrations ERP (Oracle)',
