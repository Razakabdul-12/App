...
import type {Attributes, CompanyAddress, CustomUnit, ProhibitedExpenses, Rate, TaxRate} from '@src/types/onyx/Policy';
...
function buildPolicyData(options: BuildPolicyDataOptions = {}) {
    ...
    const workspaceType = isCorporateIntegration ? CONST.POLICY.TYPE.CORPORATE : CONST.POLICY.TYPE.TEAM;
